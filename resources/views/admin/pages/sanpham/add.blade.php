    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="width: 150%">
        ...
        <div class="modal-body">
          <form  method="POST"  id="addproduct" class="form-horizontal" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group row add">
                <label class="control-label col-sm-12" for="tomtat" >Tóm tắt: </label>
                <div class="col-sm-12">
                    <textarea type="text" class="form-control" id="tomtat" name="tomtat" required></textarea>
                </div>
            </div>
            <div class="form-group row add">
                <label class="control-label col-sm-12" for="noidung" >Nội dung: </label>
                <div class="col-sm-12">
